...
void fBCRoffMB() {
  ...
  TLegend *legend1 =
      new TLegend(0.177807, 0.66396, 0.390374, 0.85876, NULL, "brNDC");
  // legend->SetHeader("Multiplicity, "+partID1[j],"C");
  setlegendstyle(legend1);

  legend1->AddEntry(h1a[0], "Jetty", "lp");
  legend1->AddEntry(h1a[2], "S_{0} Integrated", "lp");
  legend1->AddEntry(h1a[1], "Isotropic", "lp");
  ...
  c->SaveAs("pTsratio_MB_CRoff.pdf");
}
