...
void fB_jetndiso_CRoff(TString CRcase = "off", TString MPIcase = "on") {
  ...
  double Jetty[7] = {
      0.722, 0.644, 0.572, 0.533,
      0.510, 0.495, 0.483}; // min bias is not included here
  double Isotropic[7] = {0.879, 0.845, 0.808, 0.786,
                         0.772, 0.763, 0.756};
  int sphero1[7] = {58, 32, 22, 15, 10, 7, 4};
  int sphero2[7] = {242, 58, 32, 22, 15, 10, 7};
  int counter1[8] = {0};
  int counter2[8] = {0};
  int counter3[8] = {0};
  ...
  TFile *f1 = new TFile("BfracD0_CRoff.root",
