...
void fBCRonMB() {
  ...
  TFile *file = new TFile("BfracD0.root");
  ...
  // TString partname2[5] = {"ratio_I_mult_1","ratio_I_mult_3",
  // "ratio_I_mult_5", "ratio_I_mult_6", "ratio_I_mult_4"};
  ...
  TLegend *pt =
      new TLegend(0.143048, 0.816558, 0.719251, 0.920455, NULL, "brNDC");

  pt->SetHeader("pp, #sqrt{s} = 13.6 TeV, PYTHIA8, |y|<0.5");
  ...
  TLegend *legend =
      new TLegend(0.5147, 0.13311, 0.78877, 0.2532, NULL, "brNDC");
  // legend->SetHeader("Multiplicity, "+partID1[j],"C");
  setlegendstyle(legend);
  legend->AddEntry((TObject *)0, "(0-100)% FT0M", "");
