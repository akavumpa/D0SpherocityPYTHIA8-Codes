...
void SN_CRon(TString CRcase = "on", TString MPIcase = "on") {
  ...
  double sphero1[7] = {0.491, 0.503, 0.514, 0.531, 0.558, 0.614, 0.689}; // CRon
  double sphero2[7] = {0.762, 0.768, 0.775, 0.784, 0.80, 0.830, 0.864};
  double FT_1[7] = {3, 7, 9, 13, 18, 26, 46};
  double FT_2[7] = {7, 9, 13, 18, 26, 46, 200};
  Double_t FT0MClass[8] = {3, 7, 9, 13, 18, 26, 46, 200};
